            ...
            <li key={c.id}>
              ...
              >
                ...
                <div className='text-muted-foreground mt-1 text-xs'>
                  {c.started_at ?? '시작일 미정'} ~ {c.ended_at ?? '종료일 미정'}
                </div>
              </Link>
            </li>
          ))}
